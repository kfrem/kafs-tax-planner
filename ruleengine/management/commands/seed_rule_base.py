    ...
    def _create_parameters(self, release_2024, release_2025, release_2026):
        ...
        rows = [
            ...
            ("capital_allowances.full_expensing",
             ...
             {"main_rate_fya": 1.00, "special_rate_fya": 0.50}, None),
    ...
    def _create_strategies(self, release_2024, release_iht, release_property, authorities):
        ...
        specs = [
            ...
            dict(
                ...
                "of the excess trickling through at the writing-down rate (18% to 2025/26, "
                "14% from April 2026). This "
    ...
    def _create_golden_cases(self):
        cases = [
            ...
            dict(
                ...
                source="Hand-computed: 1,200,000 -> 1,000,000 AIA + 200,000 at the 14% WDA "
                "(28,000) = 1,028,000 allowance; at 25% saves 257,000 (WDA fell 18%->14% from "
                "April 2026).",
                tax_year="2026/27",
