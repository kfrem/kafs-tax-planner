...
Generated 27 July 2026. Machine pre-check: **3 failed checks** across 44 parameters, 51 strategies, 67 authorities.
...
`capital_allowances.aia` — corporation_tax — release 2025.1 — effective 2024-04-06 to 2026-04-06
- aia_limit: **1,000,000**
- main_pool_wda: **0.18**
...
### 2. Capital allowances: AIA limit and writing-down rates  
`capital_allowances.aia` — corporation_tax — release 2026.1 — effective 2026-04-06 to open
- aia_limit: **1,000,000**
- main_pool_wda: **0.14**
- special_rate_wda: **0.06**
- PASS — consumed by a registered calculator (strategy.capital_allowances, strategy.capital_allowances_full_expensing, strategy.commercial_property_fixtures)
...
### 3. Full expensing FYA rates (companies, new plant; CAA 2001 s.45S, permanent)  
...
### 4. Corporation tax rates and marginal relief  
...
### 5. Directors' loan s.455 charge rate  
...
### 6. Employer (secondary) Class 1 NIC  
...
### 8. Patent Box effective corporation-tax rate  
...
### 9. R&D merged-scheme (RDEC) above-the-line credit rate  
...
### 11. IHT Business/Agricultural Property Relief: 100% rate and combined cap  
`iht.business_property_relief` — inheritance_tax — release 2026.1 — effective 2026-04-06 to open
- full_relief_cap: **2,500,000**
- rate_above_cap: **0.5**
- PASS — consumed by a registered calculator (strategy.business_property_relief)
- PASS — figure exercised by golden test cases (strategy.business_property_relief)
- PASS — belongs to a released rule-base version (2026.1)

### 12. IHT gift exemptions and PET taper relief  
...
### 13. IHT nil-rate band (frozen through 2029/30)  
...
### 14. IHT rates: death, reduced charitable, lifetime CLT  
...
### 15. IHT residence nil-rate band and taper  
...
### 19. Income tax bands (non-savings, non-dividend)  
...
### 20. Marriage Allowance transferable amount  
...
### 22. ISA annual subscription limit  
...
### 25. Pension annual allowance and taper  
...
### 26. Residential landlord finance-cost (mortgage interest) tax-reducer rate  
`property_income.finance_cost_restriction` — personal_income_tax — release 2025.1 — effective 2025-04-06 to open
- reducer_rate: **0.2**
- PASS — consumed by a registered calculator (strategy.property_income_finance_cost, strategy.fhl_abolition_transition, strategy.property_incorporation)
- PASS — figure exercised by golden test cases (strategy.property_income_finance_cost, strategy.fhl_abolition_transition, strategy.property_incorporation)
- PASS — belongs to a released rule-base version (2025.1)

### 27. Termination payment income-tax exemption (ITEPA 2003 s.403)  
...
### 28. EIS/SEIS/VCT income-tax relief rates, annual limits and CGT treatment  
...
### 31. Business Asset Disposal Relief: reduced CGT rate and lifetime limit  
...
### 32. Lettings relief cap (shared-occupancy let, TCGA 1992 s.223B)  
...
### 33. CGT rates by asset class (lower = within basic band; residential and other deliberately aligned at 18%/24% since 30 Oct 2024)  
...
### 34. EOT disposal relief: exempt fraction of the gain (TCGA 1992 s.236H)  
`eot.relief` — property_taxes — release 2025.3 — effective 2024-04-06 to 2025-11-26
- exempt_fraction: **1.0**
- PASS — consumed by a registered calculator (strategy.eot_disposal_relief)
- PASS — figure exercised by golden test cases (strategy.eot_disposal_relief)
- PASS — belongs to a released rule-base version (2025.3)

### 35. EOT disposal relief: exempt fraction of the gain (TCGA 1992 s.236H)  
`eot.relief` — property_taxes — release 2026.1 — effective 2025-11-26 to open
- exempt_fraction: **0.5**
- PASS — consumed by a registered calculator (strategy.eot_disposal_relief)
- PASS — figure exercised by golden test cases (strategy.eot_disposal_relief)
- PASS — belongs to a released rule-base version (2026.1)

### 36. LBTT lease: NPV discount rate and bands (Scotland)  
...
### 37. LBTT non-residential freehold bands (Scotland)  
...
### 38. LBTT residential bands, Additional Dwelling Supplement, first-time buyer relief (Scotland)  
...
### 39. LTT non-residential lease: NPV discount rate and bands (Wales)  
...
### 40. LTT non-residential freehold bands (Wales)  
...
### 41. LTT residential main and higher (additional-property) bands (Wales)  
...
### 42. SDLT non-residential lease: NPV discount rate and bands (England/NI)  
...
### 43. SDLT non-residential/mixed freehold bands (England/NI)  
...
- bands:
  ...
  - rate: **0.05**
  - upper: **None**
- PASS — consumed by a registered calculator (strategy.sdlt_non_residential_purchase, strategy.sdlt_mixed_use_classification, strategy.sdlt_uninhabitable_classification)
- PASS — figure exercised by golden test cases (strategy.sdlt_non_residential_purchase, strategy.sdlt_mixed_use_classification, strategy.sdlt_uninhabitable_classification)
- PASS — belongs to a released rule-base version (2025.3)
- Source cross-reference: 150,000 appears in: Finance Act 2003 Sch 5 (amount of tax chargeable: rent); Finance Act 2003 s.55 (SDLT rate tables: s.55(1A) Table A residential; s.55(1B) Table B non-residential/mixed); Inheritance Tax Act 1984 s.8D
- Source cross-reference: 250,000 appears in: Corporation Tax Act 2010 Part 3A (ss.18A-18M); Finance Act 2003 Sch 4ZA (higher rates for additional dwellings); Finance Act 2003 s.55 (SDLT rate tables: s.55(1A) Table A residential; s.55(1B) Table B non-residential/mixed)

### 44. SDLT residential bands, surcharge, FTB relief (England/NI)  
...
- PASS — consumed by a registered calculator (strategy.property_incorporation, sdlt_residential, strategy.sdlt_purchase_planning, strategy.sdlt_mixed_use_classification, strategy.sdlt_uninhabitable_classification)
- PASS — figure exercised by golden test cases (strategy.property_incorporation, sdlt_residential, strategy.sdlt_mixed_use_classification, strategy.sdlt_uninhabitable_classification)
- PASS — belongs to a released rule-base version (2025.3)
...
### 45. Capital allowances / Annual Investment Allowance  
`capital-allowances-aia` — corporation_tax — risk **settled**, timeframe short
> Qualifying spend on plant and machinery gets 100% tax relief in the year of purchase through the Annual Investment Allowance, up to the AIA limit (currently £1,000,000). Spend above that is written down in the main pool at 18% a year up to 2025/26, falling to 14% from April 2026 (Autumn Budget 2025). This quantifies the first-year deduction and the tax it saves at the client's marginal rate — often a reason to time capital spend into a particular period. Note: a new 40% first-year allowance for qualifying main-rate expenditure from 1 January 2026 is not yet modelled here (a documented next step) — the adviser should factor it in for main-rate spend above the AIA that does not qualify for full expensing.
...
### 47. Capital allowances on commercial-property fixtures  
...
### 48. Directors' loan s.455 charge  
...
### 49. Employer pension contribution  
...
### 50. Group relief for company losses  
...
### 51. Holding-company structuring (retain profits in the group)  
...
### 52. Patent Box (10% rate on patented-product profits)  
...
### 53. R&D tax relief (merged scheme)  
...
### 54. Employee Ownership Trust sale (CGT-free)  
...
### 55. Incorporation versus remaining a sole trader  
...
### 56. Property portfolio incorporation (should the landlord incorporate?)  
...
### 57. Salary/dividend extraction mix  
...
### 58. Business / Agricultural Property Relief  
`business-property-relief` — inheritance_tax — risk **settled**, timeframe long
> Qualifying business and agricultural property is relieved from inheritance tax — at 100% for an unquoted trading business or qualifying farmland. From 6 April 2026 the 100% rate is capped at a combined £2,500,000 allowance per person, with 50% relief on anything above that (Finance Act 2026; the cap was raised from the originally-announced £1m at Autumn Budget 2025). The £2.5m allowance is transferable to a spouse or civil partner (up to £5m combined) and refreshes every seven years, so a large business or farm above the allowance can face inheritance tax for the first time. This quantifies the value relieved, the taxable value left after relief, and the IHT saved. It models a single person's £2.5m allowance; spousal transferability and the 7-year refresh are a documented simplification. It assumes the rest of the estate has used the nil-rate bands, the usual position where seven figures of business property are in point. Whether specific assets qualify (trading vs investment, two-year ownership) is a judgement the accountant confirms.
- Authority: [Inheritance Tax Act 1984 ss.103-114 (BPR), ss.115-124C (APR), ss.124D-124E (the £2.5m allowance, inserted by Finance Act 2026)](https://www.legislation.gov.uk/ukpga/1984/51/part/V/chapter/I) (in_force)
- PASS — calculator registered (strategy.business_property_relief)
- PASS — adapter registered
- PASS — has legal authorities (1 cited)
- PASS — plain-English explanation present (1051 chars)
- PASS — risk status set (settled)
- PASS — timeframe set (long)

### 59. Charitable legacy and the 36% reduced rate  
...
### 60. Lifetime gifting: exemptions and potentially exempt transfers  
...
### 61. Spouse exemption and transferable nil-rate bands  
`iht-spousal-transfer-and-nil-rate-bands` — inheritance_tax — risk **settled**, timeframe long
> Transfers between spouses or civil partners are exempt from inheritance tax, and any nil-rate band and residence nil-rate band unused on the first death transfers to the survivor. Leaving the estate to the surviving spouse defers all tax to the second death, where up to double both bands (currently £650,000 plus £350,000 where the home passes to direct descendants) shelter the combined estate. The transferred bands must be claimed by the survivor's personal representatives within two years. This models the ordinary case of a UK-resident couple, where the spouse exemption is unlimited. Cross-border caveat (from 6 April 2025): where a long-term UK resident leaves assets to a spouse who is not a long-term resident, the exemption is restricted unless that spouse elects to be treated as long-term resident — the domicile-based test was replaced by a residence-based one (Finance Act 2025), which the adviser confirms in an international case.
...
- PASS — plain-English explanation present (948 chars)
- PASS — risk status set (settled)
- PASS — timeframe set (long)

### 62. Life policy in trust to fund the IHT bill  
...
### 63. Pension death-benefit IHT (from April 2027)  
`pension-death-benefit` — inheritance_tax — risk **borderline**, timeframe long
> Today an unused pension pot normally passes on death outside the estate, free of inheritance tax. For deaths on or after 6 April 2027 most pension funds are brought into the estate for IHT — now enacted by Finance Act 2026 (Royal Assent 18 March 2026), not merely proposed. This shows the extra inheritance tax a pot would attract from that date — 40% where the estate is already above the nil-rate band — so a client can plan (for example, drawing the pension down or gifting) ahead of the change. Enacted exclusions the adviser should apply: registered-scheme death-in-service benefits, charity lump-sum death benefits, funds passing to a surviving spouse/civil partner (still exempt), and small funds. This models the headline 40% charge on a taxable pot; the exclusions and the simplified pot treatment are flagged, and because the charge is forward-dated to 2027 the position is still flagged for review.
- Authority: [IHTA 1984 s.3 (as amended by Finance Act 2026, effective 6 April 2027)](https://www.legislation.gov.uk/ukpga/1984/51/section/3) (in_force)
- PASS — calculator registered (strategy.pension_death_benefit)
- PASS — adapter registered
- PASS — has legal authorities (1 cited)
- PASS — plain-English explanation present (909 chars)
- PASS — risk status set (borderline)
- PASS — timeframe set (long)

### 64. Relevant-property trust IHT charges  
...
### 65. Gift of shares or property to charity  
...
### 66. Furnished Holiday Lettings abolition — transitional planning  
`fhl-abolition-transition` — personal_income_tax — risk **settled**, timeframe short
> The furnished holiday lettings regime was abolished from 6 April 2025 (1 April 2025 for companies), so a former FHL is now taxed as an ordinary property business. The two annual hits this quantifies are the s.24 finance-cost restriction — FHLs were exempt, so a mortgaged higher-rate landlord now pays more tax as interest is relieved only at 20% — and the loss of capital allowances on new furnishings (replaced by replacement-of-domestic-items relief on like-for-like replacements only). It also shows the writing-down allowance still claimable on the capital-allowances pool carried forward at 5 April 2025. Pre-April-2025 FHL losses carry forward into the property business, and a Business Asset Disposal Relief claim on sale is available only under the transitional window — points the adviser weighs when deciding whether to incorporate, sell, or hold.
- Authority: [Finance Act 2025 s.25 and Sch 5 (abolition of the FHL regime)](https://www.legislation.gov.uk/ukpga/2025/8/schedule/5) (in_force)
- Authority: [Income Tax (Trading and Other Income) Act 2005 ss.272A-274C](https://www.legislation.gov.uk/ukpga/2005/5/section/272A) (in_force)
- PASS — calculator registered (strategy.fhl_abolition_transition)
- PASS — adapter registered
- PASS — has legal authorities (2 cited)
- PASS — plain-English explanation present (858 chars)
- PASS — risk status set (settled)
- PASS — timeframe set (short)

### 67. Gift Aid higher-rate relief  
...
### 68. Timing of income across tax years  
...
### 69. Bed-and-ISA (shelter investments in an ISA)  
...
### 70. Marriage Allowance transfer  
...
### 71. Partnership / LLP profit-share allocation  
...
### 72. Payroll Giving (pre-tax donation from salary)  
...
### 73. Pension annual allowance carry-forward  
...
### 74. Personal pension contribution (relief at source)  
...
### 75. Landlord finance-cost restriction (s.24)  
...
### 76. Salary sacrifice into an employer pension  
...
### 77. Termination payment (£30,000 exemption)  
...
### 78. EIS / SEIS / VCT investment relief  
...
### 79. Business Asset Disposal Relief  
...
### 80. Lettings relief (shared-occupancy let)  
...
### 81. Private residence relief on property disposal  
...
### 82. Business-asset rollover relief  
...
### 83. Spousal transfer before disposal  
...
### 84. Timing of disposals across tax years  
...
### 86. LBTT on non-residential purchase (Scotland)  
...
### 87. LBTT on planned property purchase (Scotland)  
...
### 88. LTT on a non-residential lease (Wales)  
...
### 89. LTT on non-residential purchase (Wales)  
...
### 90. LTT on planned property purchase (Wales)  
...
### 91. SDLT on a non-residential lease (England/NI)  
...
### 92. SDLT mixed-use classification (England/NI)  
...
### 93. SDLT on non-residential purchase (England/NI)  
...
### 94. SDLT on planned residential property purchase (England/NI)  
...
### 95. SDLT uninhabitable-dwelling classification (England/NI)  
`sdlt-uninhabitable-classification` — property_taxes — risk **borderline**, timeframe short
> A building that is not 'suitable for use as a dwelling' at the effective date is not residential property for SDLT (FA 2003 s.116), so it is charged at the non-residential rates with no additional-dwelling surcharge. But the bar is very high, and it was raised further by the binding Court of Appeal decision in Mudan v HMRC [2025] EWCA Civ 799: a dilapidated, vandalised house needing rewiring, plumbing, a boiler and window repairs was still 'residential', because it retained the fundamental characteristics of a dwelling. Needing repair or renovation — even extensive work — is NOT enough; the condition must be so severe (structural danger, genuine dereliction) that the building cannot realistically be used as a dwelling at all. The narrow P N Bewley [2019] UKFTT 65 facts (asbestos throughout, radiators removed, unsafe) remain the kind of extreme case that can still qualify. HMRC challenges these claims hard, so the condition must be genuine and evidenced at completion (survey, photographs) — this is flagged borderline for good reason. This quantifies the residential treatment (with any surcharge) against the non-residential charge if the high threshold is met.
- Authority: [Finance Act 2003 s.116 (meaning of residential property)](https://www.legislation.gov.uk/ukpga/2003/14/section/116) (in_force)
- Authority: [Mudan & Anor v HMRC [2025] EWCA Civ 799](https://www.bailii.org/ew/cases/EWCA/Civ/2025/799.html) (in_force)
- PASS — calculator registered (strategy.sdlt_uninhabitable_classification)
- PASS — adapter registered
- PASS — has legal authorities (2 cited)
- PASS — plain-English explanation present (1176 chars)
- PASS — risk status set (borderline)
- PASS — timeframe set (short)
...
### 96. [Capital Allowances Act 2001 s.45S](https://www.legislation.gov.uk/ukpga/2001/2/section/45S) — Statute
...
### 97. [Capital Allowances Act 2001 s.51A](https://www.legislation.gov.uk/ukpga/2001/2/section/51A) — Statute
...
### 98. [Capital Allowances Act 2001 ss.33A-33B & s.187A (integral features / fixtures)](https://www.legislation.gov.uk/ukpga/2001/2/section/33A) — Statute
...
### 99. [Corporation Tax Act 2009 Part 13 (as amended, merged R&D scheme)](https://www.legislation.gov.uk/ukpga/2009/4/part/13) — Statute
...
### 100. [Corporation Tax Act 2009 Part 9A s.931A](https://www.legislation.gov.uk/ukpga/2009/4/section/931A) — Statute
...
### 101. [Corporation Tax Act 2009 s.54](https://www.legislation.gov.uk/ukpga/2009/4/section/54) — Statute
...
### 102. [Corporation Tax Act 2010 Part 3A (ss.18A-18M)](https://www.legislation.gov.uk/ukpga/2010/4/part/3A) — Statute
...
### 103. [Corporation Tax Act 2010 Part 5 (ss.97-188)](https://www.legislation.gov.uk/ukpga/2010/4/part/5) — Statute
...
### 104. [Corporation Tax Act 2010 Part 8A (Patent Box)](https://www.legislation.gov.uk/ukpga/2010/4/part/8A) — Statute
...
### 105. [Corporation Tax Act 2010 s.455](https://www.legislation.gov.uk/ukpga/2010/4/section/455) — Statute
...
### 106. [Finance Act 2003 s.116 (meaning of residential property)](https://www.legislation.gov.uk/ukpga/2003/14/section/116) — Statute
> Residential property means a building that is used or suitable for use as a dwelling, or is in the process of being constructed or adapted for such use, together with its garden or grounds; anything else is non-residential. The leading authority on 'suitable for use as a dwelling' is now Mudan & Anor v HMRC [2025] EWCA Civ 799 (Court of Appeal): a building that needs repair or renovation — even significant work — generally retains the character of a dwelling, so the bar for non-residential treatment is high (the condition must be such that it cannot realistically be used as a dwelling at the effective date). This narrows the earlier first-instance P N Bewley [2019] UKFTT 65. Where a building is equally suitable for a dwelling and another use it is treated as a dwelling; six or more dwellings in one transaction are treated as non-residential.
- PASS — canonical URI recorded (https://www.legislation.gov.uk/ukpga/2003/14/section/116)
- PASS — primary source fetched by watcher (6,043 chars of source text on file)
- PASS — status is in force (in_force)
- PASS — verbatim extract on file

### 107. [Finance Act 2003 s.55 (SDLT rate tables: s.55(1A) Table A residential; s.55(1B) Table B non-residential/mixed)](https://www.legislation.gov.uk/ukpga/2003/14/section/55) — Statute
...
### 108. [Finance Act 2003 Sch 4ZA (higher rates for additional dwellings)](https://www.legislation.gov.uk/ukpga/2003/14/schedule/4ZA) — Statute
...
### 109. [Finance Act 2003 Sch 5 (amount of tax chargeable: rent)](https://www.legislation.gov.uk/ukpga/2003/14/schedule/5) — Statute
...
### 110. [Finance Act 2003 Sch 6ZA](https://www.legislation.gov.uk/ukpga/2003/14/schedule/6ZA) — Statute
...
### 111. [Finance Act 2004 s.190](https://www.legislation.gov.uk/ukpga/2004/12/section/190) — Statute
...
### 112. [Finance Act 2004 s.197](https://www.legislation.gov.uk/ukpga/2004/12/section/197) — Statute
...
### 113. [Finance Act 2004 s.228](https://www.legislation.gov.uk/ukpga/2004/12/section/228) — Statute
...
### 114. [Finance Act 2025 s.25 and Sch 5 (abolition of the FHL regime)](https://www.legislation.gov.uk/ukpga/2025/8/schedule/5) — Statute
> Schedule 5 (title: 'Furnished holiday lettings') removes the special tax treatment of furnished holiday lettings by repealing the provisions that treated such businesses as trades (ITTOIA 2005 Part 3 Ch 6; CTA 2009 Part 4 Ch 6). From 6 April 2025 (income tax / CGT) and 1 April 2025 (corporation tax) a former FHL is taxed as an ordinary property business: the s.24 finance-cost restriction applies, capital allowances on new furnishings cease (replaced by replacement-of-domestic-items relief), and FHL-specific CGT reliefs no longer apply save under transitional rules. Losses and existing capital-allowances pools at 5 April 2025 carry forward into the continuing property business.
- PASS — canonical URI recorded (https://www.legislation.gov.uk/ukpga/2025/8/schedule/5)
- PASS — primary source fetched by watcher (22,801 chars of source text on file)
- PASS — status is in force (in_force)
- PASS — verbatim extract on file

### 115. [IHTA 1984 s.3 (as amended by Finance Act 2026, effective 6 April 2027)](https://www.legislation.gov.uk/ukpga/1984/51/section/3) — Statute
> Enacted by Finance Act 2026 (Royal Assent 18 March 2026): for deaths on or after 6 April 2027, most unused pension funds and death benefits are brought within the value of a person's estate for inheritance tax, reversing the current position where they normally pass outside the estate. Enacted exclusions: registered-scheme death-in-service benefits, charity lump-sum death benefits, and the existing spouse/civil-partner exemption (maintained). Personal representatives may ask a scheme to withhold up to 50% of the benefit for up to 15 months to meet the IHT. This is a forward-dated charge (from 2027) modelled as a planning projection.
- PASS — canonical URI recorded (https://www.legislation.gov.uk/ukpga/1984/51/section/3)
- **FAIL** — primary source fetched by watcher (0 chars of source text on file)
- PASS — status is in force (in_force)
- PASS — verbatim extract on file

### 116. [IHTA 1984 s.3 (as to be amended from 6 April 2027, Finance Bill 2025-26)](https://www.legislation.gov.uk/ukpga/1984/51/section/3) — Statute
...
### 117. [Income Tax Act 2007 Part 5 (EIS), Part 5A (SEIS), Part 6 (VCT)](https://www.legislation.gov.uk/ukpga/2007/3/part/5) — Statute
...
### 118. [Income Tax Act 2007 s.13A](https://www.legislation.gov.uk/ukpga/2007/3/section/13A) — Statute
...
### 119. [Income Tax Act 2007 s.35](https://www.legislation.gov.uk/ukpga/2007/3/section/35) — Statute
...
### 120. [Income Tax Act 2007 s.414](https://www.legislation.gov.uk/ukpga/2007/3/section/414) — Statute
...
### 121. [Income Tax Act 2007 s.431](https://www.legislation.gov.uk/ukpga/2007/3/section/431) — Statute
...
### 122. [Income Tax Act 2007 ss.55A-55E](https://www.legislation.gov.uk/ukpga/2007/3/section/55A) — Statute
...
### 123. [Income Tax (Earnings and Pensions) Act 2003 Part 12 (ss.713-715)](https://www.legislation.gov.uk/ukpga/2003/1/section/713) — Statute
...
### 124. [Income Tax (Earnings and Pensions) Act 2003 s.18](https://www.legislation.gov.uk/ukpga/2003/1/section/18) — Statute
...
### 125. [Income Tax (Earnings and Pensions) Act 2003 s.401](https://www.legislation.gov.uk/ukpga/2003/1/section/401) — Statute
...
### 126. [Income Tax (Earnings and Pensions) Act 2003 s.402D](https://www.legislation.gov.uk/ukpga/2003/1/section/402D) — Statute
...
### 127. [Income Tax (Earnings and Pensions) Act 2003 s.403](https://www.legislation.gov.uk/ukpga/2003/1/section/403) — Statute
...
### 128. [Income Tax (Trading and Other Income) Act 2005 s.694](https://www.legislation.gov.uk/ukpga/2005/5/section/694) — Statute
...
### 129. [Income Tax (Trading and Other Income) Act 2005 s.850](https://www.legislation.gov.uk/ukpga/2005/5/section/850) — Statute
...
### 130. [Income Tax (Trading and Other Income) Act 2005 s.850C](https://www.legislation.gov.uk/ukpga/2005/5/section/850C) — Statute
...
### 131. [Income Tax (Trading and Other Income) Act 2005 ss.272A-274C](https://www.legislation.gov.uk/ukpga/2005/5/section/272A) — Statute
...
### 132. [Income Tax (Trading and Other Income) Act 2005 ss.383-384](https://www.legislation.gov.uk/ukpga/2005/5/section/383) — Statute
...
### 133. [Inheritance Tax Act 1984 s.18](https://www.legislation.gov.uk/ukpga/1984/51/section/18) — Statute
> Transfers between spouses or civil partners are exempt transfers, and the exemption is unlimited in the ordinary case. From 6 April 2025 (Finance Act 2025), following abolition of the domicile-based regime, the exemption is restricted only where a long-term UK resident (LTR — resident in at least 10 of the previous 20 tax years) transfers to a spouse/civil partner who is NOT a long-term resident; the non-LTR spouse may elect to be treated as LTR (the election lasting until 10 consecutive non-resident years). The old 'UK-domiciled' test no longer applies.
...
### 134. [Inheritance Tax Act 1984 s.19](https://www.legislation.gov.uk/ukpga/1984/51/section/19) — Statute
...
### 135. [Inheritance Tax Act 1984 s.3A](https://www.legislation.gov.uk/ukpga/1984/51/section/3A) — Statute
...
### 136. [Inheritance Tax Act 1984 s.5 (meaning of estate)](https://www.legislation.gov.uk/ukpga/1984/51/section/5) — Statute
...
### 137. [Inheritance Tax Act 1984 s.7 and Sch 1](https://www.legislation.gov.uk/ukpga/1984/51/section/7) — Statute
...
### 138. [Inheritance Tax Act 1984 s.8A](https://www.legislation.gov.uk/ukpga/1984/51/section/8A) — Statute
...
### 139. [Inheritance Tax Act 1984 s.8D](https://www.legislation.gov.uk/ukpga/1984/51/section/8D) — Statute
...
### 140. [Inheritance Tax Act 1984 s.8G](https://www.legislation.gov.uk/ukpga/1984/51/section/8G) — Statute
...
### 141. [Inheritance Tax Act 1984 Sch 1A](https://www.legislation.gov.uk/ukpga/1984/51/schedule/1A) — Statute
...
### 142. [Inheritance Tax Act 1984 ss.103-114 (BPR) and ss.115-124C (APR)](https://www.legislation.gov.uk/ukpga/1984/51/part/V/chapter/I) — Statute
...
### 143. [Inheritance Tax Act 1984 ss.103-114 (BPR), ss.115-124C (APR), ss.124D-124E (the £2.5m allowance, inserted by Finance Act 2026)](https://www.legislation.gov.uk/ukpga/1984/51/part/V/chapter/I) — Statute
> Business property relief reduces the value transferred by relevant business property by 100% (unquoted trading businesses and unquoted shares) or 50% (controlling quoted holdings, certain land and machinery). Agricultural property relief similarly relieves the agricultural value of qualifying farmland at 100% or 50%. From 6 April 2026 the 100% rate is limited to a combined allowance of £2,500,000 of qualifying business and agricultural property, with 50% relief on value above that cap. The cap was raised from the originally-announced £1,000,000 at Autumn Budget 2025 and enacted by Finance Act 2026 (new IHTA 1984 ss.124D-124E); the allowance is transferable between spouses/civil partners (up to £5m combined) and refreshes every seven years.
- PASS — canonical URI recorded (https://www.legislation.gov.uk/ukpga/1984/51/part/V/chapter/I)
- **FAIL** — primary source fetched by watcher (0 chars of source text on file)
- PASS — status is in force (in_force)
- PASS — verbatim extract on file

### 144. [Inheritance Tax Act 1984 ss.58-69 (relevant property)](https://www.legislation.gov.uk/ukpga/1984/51/part/III/chapter/III) — Statute
...
### 145. [Jones v Garnett (Arctic Systems) [2007] UKHL 35](https://www.bailii.org/uk/cases/UKHL/2007/35.html) — Court Judgment
...
### 146. [Land and Buildings Transaction Tax (Scotland) Act 2013 s.24](https://www.legislation.gov.uk/asp/2013/11/section/24) — Statute
...
### 147. [Land and Buildings Transaction Tax (Scotland) Act 2013 Sch 2A](https://www.legislation.gov.uk/asp/2013/11/schedule/2A) — Statute
...
### 148. [Land Transaction Tax and Anti-avoidance of Devolved Taxes (Wales) Act 2017 s.24](https://www.legislation.gov.uk/anaw/2017/1/section/24) — Statute
...
### 149. [Land Transaction Tax and Anti-avoidance of Devolved Taxes (Wales) Act 2017 Sch 5](https://www.legislation.gov.uk/anaw/2017/1/schedule/5) — Statute
...
### 150. [Mudan & Anor v HMRC [2025] EWCA Civ 799](https://www.bailii.org/ew/cases/EWCA/Civ/2025/799.html) — Court Judgment
> Court of Appeal, 27 June 2025. A dilapidated and vandalised house requiring extensive works (rewiring, plumbing, boiler, broken windows, water ingress) was still 'residential property' for SDLT because it retained the fundamental characteristics of a dwelling. The threshold for showing a building is NOT suitable for use as a dwelling is high: needing repair or renovation, even significant work, is not enough — the condition must be such that it cannot realistically be used as a dwelling at the effective date. This binding decision narrows the earlier first-instance P N Bewley approach and is the current leading authority on FA 2003 s.116.
- PASS — canonical URI recorded (https://www.bailii.org/ew/cases/EWCA/Civ/2025/799.html)
- **FAIL** — primary source fetched by watcher (0 chars of source text on file)
- PASS — status is in force (in_force)
- PASS — verbatim extract on file

### 151. [Social Security Contributions and Benefits Act 1992 s.10](https://www.legislation.gov.uk/ukpga/1992/4/section/10) — Statute
...
### 152. [Social Security Contributions and Benefits Act 1992 s.15](https://www.legislation.gov.uk/ukpga/1992/4/section/15) — Statute
...
### 153. [Social Security Contributions and Benefits Act 1992 s.6](https://www.legislation.gov.uk/ukpga/1992/4/section/6) — Statute
...
### 154. [Taxation of Chargeable Gains Act 1992 s.152](https://www.legislation.gov.uk/ukpga/1992/12/section/152) — Statute
...
### 155. [Taxation of Chargeable Gains Act 1992 s.162](https://www.legislation.gov.uk/ukpga/1992/12/section/162) — Statute
...
### 156. [Taxation of Chargeable Gains Act 1992 s.223B](https://www.legislation.gov.uk/ukpga/1992/12/section/223B) — Statute
...
### 157. [Taxation of Chargeable Gains Act 1992 s.236H (Employee Ownership Trust)](https://www.legislation.gov.uk/ukpga/1992/12/section/236H) — Statute
> A disposal of shares in a trading company to an Employee Ownership Trust that acquires a controlling interest gets relief from capital gains tax provided the qualifying conditions are met (UK-resident trustees, former owners not to retain control, a clawback period and an independent valuation, tightened by Finance Act 2024/2025). For disposals up to 25 November 2025 the relief was a full no-gain/no-loss exemption. For disposals on or after 26 November 2025 (Finance Act 2026 s.35), only 50% of the gain is relieved — the other 50% is chargeable at the standard rate with no Business Asset Disposal Relief or Investors' Relief; the relieved half reduces the trustees' acquisition cost.
...
### 158. [Taxation of Chargeable Gains Act 1992 s.257](https://www.legislation.gov.uk/ukpga/1992/12/section/257) — Statute
...
### 159. [Taxation of Chargeable Gains Act 1992 s.58](https://www.legislation.gov.uk/ukpga/1992/12/section/58) — Statute
...
### 160. [Taxation of Chargeable Gains Act 1992 ss.169H-169S](https://www.legislation.gov.uk/ukpga/1992/12/section/169H) — Statute
...
### 161. [Taxation of Chargeable Gains Act 1992 ss.1H-1K](https://www.legislation.gov.uk/ukpga/1992/12/section/1H) — Statute
...
### 162. [Taxation of Chargeable Gains Act 1992 ss.222-223](https://www.legislation.gov.uk/ukpga/1992/12/section/222) — Statute
...
|---|---|---|---|
| 1–162 | _(name)_ | _(YES / exceptions)_ | _(date)_ |
