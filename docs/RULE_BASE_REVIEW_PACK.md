...
Generated 06 July 2026. Machine pre-check: **0 failed checks** across 37 parameters, 34 strategies, 41 authorities.
...
- PASS — consumed by a registered calculator (strategy.capital_allowances)
- PASS — figure exercised by golden test cases (strategy.capital_allowances)
- PASS — belongs to a released rule-base version (2025.1)
- Source cross-reference: 1,000,000 appears in: Capital Allowances Act 2001 s.51A
...
- PASS — consumed by a registered calculator (corporation_tax, strategy.capital_allowances, strategy.salary_dividend_mix, strategy.pension_annual_allowance_carry_forward, strategy.employer_pension_contribution, strategy.group_loss_relief, strategy.incorporation_vs_sole_trade)
- PASS — figure exercised by golden test cases (corporation_tax, strategy.capital_allowances, strategy.pension_annual_allowance_carry_forward, strategy.employer_pension_contribution, strategy.group_loss_relief, strategy.incorporation_vs_sole_trade)
- PASS — belongs to a released rule-base version (2025.1)
...
- PASS — belongs to a released rule-base version (2025.1)
- Source cross-reference: 5,000 appears in: Finance Act 2003 s.55 and Sch 4ZA; Inheritance Tax Act 1984 s.8D; Inheritance Tax Act 1984 ss.58-69 (relevant property)
...
### 6. IHT Business/Agricultural Property Relief: 100% rate and combined cap  
...
### 7. IHT Business/Agricultural Property Relief: 100% rate and combined cap  
...
### 8. IHT gift exemptions and PET taper relief  
...
- PASS — belongs to a released rule-base version (2025.2)
- Source cross-reference: 250 appears in: Corporation Tax Act 2010 Part 3A (ss.18A-18M); Finance Act 2003 s.55 and Sch 4ZA; Income Tax Act 2007 Part 5 (EIS), Part 5A (SEIS), Part 6 (VCT)
- Source cross-reference: 3,000 appears in: Income Tax Act 2007 Part 5 (EIS), Part 5A (SEIS), Part 6 (VCT); Inheritance Tax Act 1984 s.19; Inheritance Tax Act 1984 ss.58-69 (relevant property)

### 9. IHT nil-rate band (frozen through 2029/30)  
`iht.nil_rate_band` — inheritance_tax — release 2025.2 — effective 2025-04-06 to open
- amount: **325,000**
- PASS — consumed by a registered calculator (strategy.relevant_property_trust_charges, iht_estate_liability, strategy.iht_spousal_transfer_nil_rate_bands, strategy.iht_lifetime_gifting, strategy.iht_charitable_legacy_reduced_rate)
- PASS — figure exercised by golden test cases (strategy.relevant_property_trust_charges, iht_estate_liability, strategy.iht_lifetime_gifting)
- PASS — belongs to a released rule-base version (2025.2)

### 10. IHT rates: death, reduced charitable, lifetime CLT  
...
- PASS — consumed by a registered calculator (strategy.business_property_relief, strategy.relevant_property_trust_charges, iht_estate_liability, strategy.iht_spousal_transfer_nil_rate_bands, strategy.iht_lifetime_gifting, strategy.iht_charitable_legacy_reduced_rate)
- PASS — figure exercised by golden test cases (strategy.business_property_relief, strategy.relevant_property_trust_charges, iht_estate_liability, strategy.iht_lifetime_gifting)
- PASS — belongs to a released rule-base version (2025.2)

### 11. IHT residence nil-rate band and taper  
...
### 15. Income tax bands (non-savings, non-dividend)  
...
- PASS — consumed by a registered calculator (income_tax_on_earned_income, combined_personal_tax, strategy.gift_aid_relief, strategy.salary_sacrifice, strategy.salary_dividend_mix, strategy.pension_annual_allowance_carry_forward, strategy.personal_pension_contribution, strategy.property_income_finance_cost, strategy.partnership_profit_allocation, strategy.incorporation_vs_sole_trade, strategy.marriage_allowance_transfer, cgt_liability, strategy.cgt_timing_of_disposals, strategy.cgt_ppr_relief, strategy.cgt_lettings_relief, strategy.cgt_spousal_transfer_before_disposal, strategy.cgt_business_asset_disposal_relief)
- PASS — figure exercised by golden test cases (income_tax_on_earned_income, combined_personal_tax, strategy.gift_aid_relief, strategy.salary_sacrifice, strategy.pension_annual_allowance_carry_forward, strategy.personal_pension_contribution, strategy.property_income_finance_cost, strategy.partnership_profit_allocation, strategy.incorporation_vs_sole_trade, strategy.marriage_allowance_transfer, cgt_liability, strategy.cgt_timing_of_disposals, strategy.cgt_lettings_relief, strategy.cgt_business_asset_disposal_relief)
- PASS — belongs to a released rule-base version (2025.1)
...
### 18. ISA annual subscription limit  
...
### 21. Pension annual allowance and taper  
...
### 22. Residential landlord finance-cost (mortgage interest) tax-reducer rate  
`property_income.finance_cost_restriction` — personal_income_tax — release 2025.1 — effective 2025-04-06 to open
- reducer_rate: **0.2**
- PASS — consumed by a registered calculator (strategy.property_income_finance_cost)
- PASS — figure exercised by golden test cases (strategy.property_income_finance_cost)
- PASS — belongs to a released rule-base version (2025.1)

### 23. EIS/SEIS/VCT income-tax relief rates, annual limits and CGT treatment  
...
### 25. Business Asset Disposal Relief: reduced CGT rate and lifetime limit  
...
### 26. Business Asset Disposal Relief: reduced CGT rate and lifetime limit  
...
### 27. Lettings relief cap (shared-occupancy let, TCGA 1992 s.223B)  
...
### 28. CGT rates by asset class (lower = within basic band)  
...
- residential:
  - lower: **0.18**
  - higher: **0.24**
- PASS — consumed by a registered calculator (strategy.isa_bed_and_isa, strategy.venture_capital_investment, cgt_liability, strategy.cgt_timing_of_disposals, strategy.cgt_ppr_relief, strategy.cgt_lettings_relief, strategy.cgt_spousal_transfer_before_disposal, strategy.cgt_business_asset_disposal_relief)
- PASS — figure exercised by golden test cases (strategy.isa_bed_and_isa, strategy.venture_capital_investment, cgt_liability, strategy.cgt_timing_of_disposals, strategy.cgt_lettings_relief, strategy.cgt_business_asset_disposal_relief)
- PASS — belongs to a released rule-base version (2025.3)

### 29. LBTT lease: NPV discount rate and bands (Scotland)  
...
### 30. LBTT non-residential freehold bands (Scotland)  
...
### 31. LBTT residential bands, Additional Dwelling Supplement, first-time buyer relief (Scotland)  
...
### 32. LTT non-residential lease: NPV discount rate and bands (Wales)  
...
### 33. LTT non-residential freehold bands (Wales)  
...
### 34. LTT residential main and higher (additional-property) bands (Wales)  
...
### 35. SDLT non-residential lease: NPV discount rate and bands (England/NI)  
...
### 36. SDLT non-residential/mixed freehold bands (England/NI)  
...
### 37. SDLT residential bands, surcharge, FTB relief (England/NI)  
...
- PASS — belongs to a released rule-base version (2025.3)
- Source cross-reference: 125,000 appears in: Finance Act 2003 s.55 and Sch 4ZA; Inheritance Tax Act 1984 s.8D; Inheritance Tax Act 1984 ss.58-69 (relevant property)
- Source cross-reference: 250,000 appears in: Corporation Tax Act 2010 Part 3A (ss.18A-18M); Finance Act 2003 s.55 and Sch 4ZA
...
### 38. Capital allowances / Annual Investment Allowance  
...
### 39. Directors' loan s.455 charge  
...
### 40. Employer pension contribution  
...
### 41. Group relief for company losses  
...
### 42. Incorporation versus remaining a sole trader  
...
### 43. Salary/dividend extraction mix  
...
### 44. Business / Agricultural Property Relief  
...
### 45. Charitable legacy and the 36% reduced rate  
...
### 46. Lifetime gifting: exemptions and potentially exempt transfers  
...
### 47. Spouse exemption and transferable nil-rate bands  
...
### 48. Relevant-property trust IHT charges  
...
### 49. Gift Aid higher-rate relief  
...
### 50. Bed-and-ISA (shelter investments in an ISA)  
...
### 51. Marriage Allowance transfer  
...
### 52. Partnership / LLP profit-share allocation  
...
### 53. Pension annual allowance carry-forward  
...
### 54. Personal pension contribution (relief at source)  
...
### 55. Landlord finance-cost restriction (s.24)  
