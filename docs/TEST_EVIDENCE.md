...
**Expected result: `197 passed`** (≈4½ minutes; the seed fixture rebuilds
...
| `ruleengine/tests/test_golden_cases.py` | 2 (data-driven) | Executes all **25 GoldenTestCase rows stored in the rule base itself** — the §5.5 release gate. Adding a golden case to the seed automatically adds coverage |
