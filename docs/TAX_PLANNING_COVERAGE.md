...
| Timing of disposals (split across tax years) | ○ | Quick — build on the existing CGT engine + annual exempt amount to compare one year vs two. | High |
...
Roughly **12 built, 4 partial, ~22 planned** of ~38 mainstream strategies.
...
Gift Aid · salary sacrifice · directors' loan / s.455 · capital allowances /
AIA · timing of disposals · finish the standalone pension-contribution and
employer-pension strategies. Each is a small, self-contained strategy that
firms use constantly — fast credibility.
